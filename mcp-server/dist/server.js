...
mcpServer.tool("get-tab-web-content", "Get the full text content of the webpage and the list of links in the webpage, by tab ID", { tabId: zod_1.z.number() }, async ({ tabId }) => {
...
mcpServer.tool("find-highlight-in-browser-tab", "Find and highlight text in a browser tab", { tabId: zod_1.z.number(), queryPhrase: zod_1.z.string() }, async ({ tabId, queryPhrase }) => {
